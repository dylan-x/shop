<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/Users/dylan/PHP/Project/shop/public/../application/admin/view/role/edit.html";i:1547297756;}*/ ?>
    ...
    <form action="" method="post" name="theForm" enctype="multipart/form-data">
        <table width="100%" id="general-table">
            <tr>
                ...
                <td>
                    <input type='text' name='role_name' maxlength="20" value='<?php echo $info['role_name']; ?>'  /> <font color="red">*</font>
                </td>
            </tr>
        </table>
