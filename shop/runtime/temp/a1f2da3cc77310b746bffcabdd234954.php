<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/Users/dylan/PHP/Project/shop/public/../application/admin/view/login/index.html";i:1547820034;}*/ ?>
...
<form method="post" action=""onsubmit="return validate()">
    <table cellspacing="0" cellpadding="0" style="margin-top:100px" align="center">
        <tr>
            <td>
                <img src="__ADMIN__/Images/login.png" width="178" height="256" border="0" alt="ECSHOP" />
            </td>
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" align="right">
                            <img src="<?php echo url('makeCaptcha'); ?>" id="captcha"  width="145" />
                        </td>
                    </tr>
                    <tr>
