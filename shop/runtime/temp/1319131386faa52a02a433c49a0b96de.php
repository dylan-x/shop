<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/Users/dylan/PHP/Project/shop/public/../application/admin/view/attribute/add.html";i:1547211512;}*/ ?>
    ...
    <form action="" method="post" name="theForm" enctype="multipart/form-data">
        <table width="100%" id="general-table">
            <tr>
                ...
                <td>
                    <input type='text' name='attr_name' maxlength="20" value='' /> <font color="red">*</font>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                   <textarea name="attr_values" style="min-height:100px; width: 200px; "></textarea>(当录入方式为列表选择必须设置 多个值英文逗号隔开)
                </td>
            </tr>
        </table>
