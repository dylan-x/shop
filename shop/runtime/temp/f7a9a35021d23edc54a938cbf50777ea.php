<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/Users/dylan/PHP/Project/shop/public/../application/admin/view/rule/add.html";i:1547888013;}*/ ?>
...
<body>
<h1>
    <span class="action-span"><a href="<?php echo url('index'); ?>">权限管理</a></span>
    ...
    <form action="" method="post" name="theForm" enctype="multipart/form-data">
        <table width="100%" id="general-table">
            <tr>
                ...
                <td>
                    <input type='text' name='rule_name' /> <font color="red">*</font>
                </td>
            </tr>
            <tr>
                <td class="label">控制器名称:</td>
                <td>
                    <input type='text' name='controller_name' /> <font color="red">*</font>
                </td>
            </tr>
            <tr>
                <td class="label">方法名称:</td>
                <td>
                    <input type='text' name='action_name' /> <font color="red">*</font>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <select name="parent_id">
                        ...
                        <option value="<?php echo $vo['id']; ?>"><?php echo str_repeat("&nbsp;&nbsp;",$vo['lev']); ?><?php echo $vo['rule_name']; ?></option>
